...
if not environment_path.exists():
    environment_path = ROOT_DIR / ".env.local"
...
if "test" in sys.argv or os.getenv("FAST_APPOINTMENT_TESTS", "False") == "True":
    ...
    APPOINTMENT_SCHEDULING_END_TIME = (datetime.now() + timedelta(days=30)).strftime(
        DATE_FORMAT
    )  # Next 30 days
...
EXPORT_EXTENSION_QUERY_PARAMETER = os.getenv(
    "VITE_EXPORT_EXTENSION_QUERY_PARAMETER", "export_format"
)
